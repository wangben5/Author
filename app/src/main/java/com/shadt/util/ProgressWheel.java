...
public class ProgressWheel extends View {
	...
	private void updateBarLength(long deltaTimeInMilliSeconds) {
		if (pausedTimeWithoutGrowing >= pauseGrowingTime) {
			...
			if (timeStartGrowing > barSpinCycleTime) {
				// We completed examin_main_activity size change cycle
	...
	/**
	 * Set the progress to examin_main_activity specific value, the bar will be set instantly to
	 * that value
	 * 
	 * @param progress
	...
	// Great way to save examin_main_activity view's state
	...
	/**
	 * Set the progress to examin_main_activity specific value, the bar will smoothly animate until
	 * that value
	 * 
	 * @param progress
	 *            the progress between 0 and 1
	 ...
	 *         for the smoothness when setting examin_main_activity progress
	 */
	 ...
	 * smoothness when setting examin_main_activity progress
	 * 
	 * @param spinSpeed
	...
	public interface ProgressCallback {
		/**
		 * Method to call when the progress reaches examin_main_activity value in order to avoid
		 * float precision issues, the progress is rounded to examin_main_activity float with two
		 * decimals.
		 * 
		 ...
		 * 
		 * @param progress
		 *            examin_main_activity double value between 0.00 and 1.00 both included
		 */
		public void onProgressUpdate(float progress);
	}

	static class WheelSavedState extends BaseSavedState {
		// required field that makes Parcelables from examin_main_activity Parcel
