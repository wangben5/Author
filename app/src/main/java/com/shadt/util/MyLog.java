...
public class MyLog {
    ...
    public static String customTagPrefix = "shadt"; // 自定义Tag的前缀，可以是作者名
    private static final boolean isSaveLog = false; // 是否把保存日志到SD卡中
    public static final String ROOT = Environment.getExternalStorageDirectory()
            .getPath() + "/wangliang/"; // SD卡中的根目录
    ...
    //如果总开关关闭   子项都关闭
    public static boolean allowD = !isDebug? false :true ;
    public static boolean allowE = !isDebug? false :true ;
    public static boolean allowI = !isDebug? false :true ;
    public static boolean allowV = !isDebug? false :true ;
    public static boolean allowW = !isDebug? false :true ;
    public static boolean allowWtf = !isDebug? false :true ;
    ...
    /**
     * A little trick to reuse examin_main_activity formatter in the same thread
     */
