...
import com.shadt.util.SealConst;
import com.shadt.util.SealUserInfoManager;
...
public class SealAppContext implements RongIM.ConversationListBehaviorListener,
    ...
    public SealAppContext(Context mContext) {
        ...
        String name = preferences.getString("rong_name", "");
    ...
    public void setUser(){
        ...
        MyLog.i("用户提供");
        String name = preferences.getString("rong_name", "");
        String id = preferences.getString("rong_img", "");
        String img = preferences.getString("ry_video_id", "");
        String ip = preferences.getString("vsOutData6", "");
        userIdList = new ArrayList<Friend>();
        userIdList.add(new Friend(id, name, ip+img));
    }
    /**
     * 初始化 RongCloud.
     *
...
//            MyLog.e("onReceived:" + groupNotificationMessage.getMessage());
...
//        SealUserInfoManager.getInstance().getGroupInfo(s);
    ...
    public void onChanged(ConnectionStatus connectionStatus) {
        MyLog.d( "ConnectionStatus onChanged = " + connectionStatus.getMessage());
    ...
    public RongIMClient.ConnectCallback getConnectCallback() {
        RongIMClient.ConnectCallback connectCallback = new RongIMClient.ConnectCallback() {
            ...
            public void onTokenIncorrect() {
                MyLog.d( "ConnectCallback connect onTokenIncorrect");
//                SealUserInfoManager.getInstance().reGetToken();
            }

            @Override
            public void onSuccess(String s) {
                MyLog.d( "ConnectCallback connect onSuccess");
            ...
            public void onError(final RongIMClient.ErrorCode e) {
                MyLog.d( "ConnectCallback connect onError-ErrorCode=" + e);
            }
        };
