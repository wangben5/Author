...
import com.shadt.activity.BaseActivity.ICallbackResult;
...
public class UPDATADownloadService extends Service {
	...
	private static final String saveFileName = savePath + "shadtnews.apk";
...
//							"文件已下载完毕", contentIntent);
	...
	public class DownloadBinder extends Binder {
		...
		public void addCallback(ICallbackResult callback) {
			UPDATADownloadService.this.callback = callback;
		}
	}
	...
	private void setUpNotification() {
		...
		contentView.setTextViewText(R.id.name,
				getResources().getString(R.string.app_name) + ".apk 正在下载...");
		Toast.makeText(mContext, "开始下载中", 0).show();
		// 指定个性化视图
		...
		// intent.putExtra("is_down", 0);//0表示不提示下载
