...
import com.shadt.ui.example.adapter.ImageGridAdapter;
import com.shadt.ui.example.model.ImageInfo;
...
public class ResultActivity extends Activity {
	...
	public void openCameraSDKImagePreview(Activity activity,String path,int position) {
		...
		mCameraSdkParameterInfo.setPosition(position);
		Intent intent = new Intent(); 
		intent.setClassName(activity.getApplication(), "com.shadt.news.cameresdk.PreviewActivity");
		Bundle b=new Bundle();
	...
	public void openCameraSDKPhotoPick(Activity activity,ArrayList<String> list) {
		Intent intent = new Intent(); 
		intent.setClassName(activity.getApplication(), "com.shadt.news.cameresdk..PhotoPickActivity");
		Bundle b=new Bundle();
