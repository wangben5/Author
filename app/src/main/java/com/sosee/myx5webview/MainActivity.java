...
//
//import com.sosee.myx5webview.X5WebView.ProgressWebView;
//
//
//import java.util.ArrayList;
//
//public class MainActivity extends AppCompatActivity {
//    private String url = "http://192.168.2.18:81/selected-topic/index.html#/task";
...
//        // WebView是否支持多个窗口。
////        webSettings.setSupportMultipleWindows(true);           ////////////////////////////    设置true  则有可能无法监听内部跳转
...
//
//        });
////        url = "https://hbhh.chinashadt.com/syncott/Modile/newsServlet?uniqueID=1ed7867d3b25468e8e302a45c248cf1c&xgyd=HomePageGDXW&createTime=2018-07-13&onapp=yes" ;
////        url = "http://appstore.chinashadt.com/wap/cms/show/?id=208&cid=453&conttype=download" ;
//        url = "http://192.168.2.18:81/selected-topic/index.html#/app" ;
//
//        webView.loadUrl(url);
//
//    }
