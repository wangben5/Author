...
final class FlashlightManager {
	...
	static {
		...
		if (iHardwareService == null) {
			Log.v(TAG, "This device does supports control of examin_main_activity flashlight");
		} else {
			Log.v(TAG, "This device does not support control of examin_main_activity flashlight");
		}
	}
