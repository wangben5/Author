package com.shadt.news.cameresdk;
...
import com.shadt.news.cameresdk.adapter.Filter_Effect_Adapter;
import com.shadt.news.cameresdk.adapter.Filter_Sticker_Adapter;
import com.shadt.news.cameresdk.adapter.FragmentViewPagerAdapter;
import com.shadt.news.cameresdk.adapter.SmallThumbAdapter;
import com.shadt.news.cameresdk.model.CameraSdkParameterInfo;
import com.shadt.news.cameresdk.model.Constants;
import com.shadt.news.cameresdk.model.Filter_Effect_Info;
import com.shadt.news.cameresdk.model.Filter_Sticker_Info;
import com.shadt.news.cameresdk.model.LocalMedia;
import com.shadt.news.cameresdk.ui.fragment.EfectFragment;
import com.shadt.news.cameresdk.utils.FilterUtils;
import com.shadt.news.cameresdk.view.CustomViewPager;
...
public class FilterImageActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            img_path = getIntent().getStringExtra("url");
...
//			imageList=mCameraSdkParameterInfo.getImage_list();
            ...
            mCameraSdkParameterInfo.setImage_list(imageList);
        ...
        Log.i("shadt", "isSingle_mode" + mCameraSdkParameterInfo.isSingle_mode());
    ...
    private void initEvent() {
        ...
        txt_cropper.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.setClassName(getApplication(), "com.shadt.news.cameresdk.CutActivity");
        ...
        txt_enhance.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                Constants.bitmap = ((EfectFragment) fragments.get(current)).getCurrentBitMap();
                Intent intent = new Intent();
                intent.setClassName(getApplication(), "com.shadt.news.cameresdk.PhotoEnhanceActivity");
                startActivityForResult(intent, Constants.RequestCode_Croper);
            }
        });
        txt_graffiti.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                intent.setClassName(getApplication(), "com.shadt.news.cameresdk.GraffitiActivity");
                startActivityForResult(intent, Constants.RequestCode_Croper);
            }
        });
    ...
    private void initData() {
        ...
        boolean flag = false;
        Log.i("shadt", "isCroper_image" + mCameraSdkParameterInfo.isCroper_image());
    ...
    private void complate_runnable(long delayMillis) {
        Runnable runnable = new Runnable() {
            ...
            public void run() {
                ...
                Log.i("shadt", "getRet_type" + mCameraSdkParameterInfo.getRet_type());
                ...
                Log.i("shadt", "is_net_path" + mCameraSdkParameterInfo.is_net_path);
                //如果是网络图片则直接返回
...
//					PhotoPickActivity.instance.getFilterComplate(list);
                    Log.i("shadt", list.size() + "list.get(0)" + list.get(0));
                    LocalMedia mLocalMedia = new LocalMedia();
                    mLocalMedia.setPictureType(isType(list.get(0)));
                    mLocalMedia.setPath(list.get(0));
                    mLocalMedia.setCompressPath(list.get(0));
                    mLocalMedia.setMimeType(1);
                    mLocalMedia.setPosition(1);
                    mLocalMedia.setNum(1);
                    Intent it = new Intent();
                    Bundle mBundle = new Bundle();
                    mBundle.putSerializable("content", mLocalMedia);
                    it.setAction("update");
                    it.putExtra("lvjing", true);
