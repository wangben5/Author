...
import com.demo.interactive.SlidingFragment;
import com.shadt.news.mylibrary.R;
    ...
    private void openFragment(int key) {
        ...
        switch (key) {
            ...
            case 4:
                ...
                mBundle.putString(SuperWebX5Fragment.URL_KEY, "http://192.168.2.18:81/selected-topic/index.html#/establish");
                break;
            //视频播放
            case 5:
