...
public class PictureExternalPreviewActivity extends PictureBaseActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        picture_edit.setVisibility(View.GONE);
        ...
        if (!TextUtils.isEmpty(img_path)){
            ...
            LocalMedia mLocal=new LocalMedia();
            mLocal.setPath(img_path);
            mLocal.setCompressPath(img_path);
            images.add(mLocal);
        }
        ...
        picture_edit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                it.setClassName(mContext, "com.shadt.news.cameresdk.FilterImageActivity");
                it.putExtra("url",images.get(0).getPath());
                startActivity(it);
                finish();
            }
        });
                ...
                if (isHttp) {
                    ...
                    try {
                        String dirPath = PictureFileUtils.createDir(PictureExternalPreviewActivity.this,
                                "shadt"+System.currentTimeMillis() + ".png", directory_path);
